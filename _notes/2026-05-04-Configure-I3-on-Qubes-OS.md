---
layout: post
title: "Configure I3 on Qubes OS"
---

# Basic I3 Install
1. Open dom0 terminal
1. type, `sudo qubes-dom0-update i3 i3-settings-qubes`
    - Pre-build package of i3
    - The Qubes OS settings
        - `qubes-i3status`
1. Log out, select i3 from the login mamager & log in again.

# The config file
 Located at the dom0 vm, `~/.config/i3/config`
